...
if [[ ! -f "$SENTINEL" ]]; then
    echo "First-time init: running specify init in /workspace..."
    cd /workspace
    ...
    specify extension add --from https://github.com/reytech-dev/spec-kit-open-design/archive/refs/tags/v1.1.1.zip spec-kit-open-design
